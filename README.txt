...
a persistence unit "AParqueaderoWSPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "AParqueaderoWS/pom.xml":
...
artifact ("AParqueaderoWS.war") is already built. You can build
